var searchQuery = "spaghetti"; //prompt("What do you want to search for?");
var queryURL = "https://api.unsplash.com/search/collections?page=1&query=" + searchQuery + "&client_id=adf1276beb83d0d9e4d4e7d77a4f5853d5864ac74debcbb7c8220c84bea6f7a5";
...
function addPicture(response, i){
    ...
    console.log(response)
    var pictureLink = response.results[i].cover_photo.urls.regular;
    console.log(pictureLink);
    var user = response.results[i].user.first_name;
    var description = "this is where the description goes"; //response[i].alt_description;
    // var img = new Image();
    var recipes = $(".grid")
    var flipCard = $(`
        <div class="flip-card card grid-item">
        </div>`);
